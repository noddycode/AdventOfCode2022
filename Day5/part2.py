...
with open('bigInput.txt') as fin:
	...
	for l in fin:
		...
		moved = crate_stacks[from_stack][-num_moved:]  # Our setup makes this change easy :D
		crate_stacks[from_stack] = crate_stacks[from_stack][:-num_moved]
		crate_stacks[to_stack].extend(moved)
