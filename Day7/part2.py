...
totalSpace = 70000000
currentSpace = rootDir.totalSize
needToDelete = 30000000 - (totalSpace - currentSpace)

output = sorted((d for d in allNodes if d.totalSize >= needToDelete), key = lambda d: d.totalSize)[0]
